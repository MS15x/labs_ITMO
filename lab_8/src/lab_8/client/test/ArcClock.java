...
public class ArcClock {
    ...
    public ArcClock(int numArcs, Color longPieceColor, Color manyPieceColor, int maxDiameter) {
        ...
        longPiece = new ArcPiece(longPieceColor, 5,0,0,
                maxDiameter,maxDiameter,45,240,
                1000,1);
    ...
    public static ArcPiece randomArcPiece(Color color, double radius) {
        ...
        final ArcPiece arcPiece = new ArcPiece(someColor, randomStrokeWidth,
                radius - (width/2),radius - (width/2),
                width,width,randomStartAngle,randomExtentAngle,
                randomMillis,2);
